...
class HueConfig(Schema):
  ...
  color_start = PhillipsHueColor(65535, if_missing={'hue': 65535, 'saturation': 255, 'value': 255})
  color_end = PhillipsHueColor(46920, if_missing={'hue': 46920, 'saturation': 255, 'value': 255})
